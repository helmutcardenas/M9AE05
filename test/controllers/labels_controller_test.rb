...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference("Label.count") do
      post labels_url, params: { label: { description: @label.description, reference_id: @label.reference_id, title: @label.title } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { description: @label.description, reference_id: @label.reference_id, title: @label.title } }
